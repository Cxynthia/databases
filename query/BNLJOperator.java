...
//                currLeftPages = new Page[numBuffers - 2];
//                int num;
//                for (num = 0; num < numBuffers - 2; num++) {
//                    if (leftIterator.hasNext()) {
//                        currLeftPages[num] = leftIterator.next();
//                    } else {
//                        break;
//                    }
//                }
//                // Remove extra slot if the buffer is not full
//                if (num != numBuffers - 3) {
//                    currLeftPages = Arrays.copyOfRange(currLeftPages, 0, num);
//                }
...
//        // Fetch the next non-empty page from the left relation.
...
//        }
        ...
        private void resetAllRightRecord() {
            this.rightIterator.reset();
            rightRecordIterator = getBlockIterator(getRightTableName(), rightIterator, 0);
            rightRecordIterator.markNext();
        }
